...
icon_path = "Images/1200px-Rock-paper-scissors.svg.png"
icon = pygame.image.load(icon_path)
pygame.display.set_icon(icon)
scissor_path = "Images/scissors.png"
stone_path = "Images/stone.png"
paper_path = "Images/document.png"
scissor = pygame.image.load(scissor_path)
stone = pygame.image.load(stone_path)
paper = pygame.image.load(paper_path)
background_path = "Images/4882066.jpg"
background = pygame.image.load(background_path)
background = pygame.transform.scale(background, (800, 600))
restart_path = "Images/update-arrow.png"
restart = pygame.image.load(restart_path)
pause_path = "Images/pause-outlined-big-symbol.png"
pause = pygame.image.load(pause_path)
setting_path = "Images/settings.png"
